...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_testprojectjava_9326;
            let db_auth = result.data.DB_AUTH_testprojectjava_9326;
            let db_coll = result.data.DB_COLL_testprojectjava_9326;
